...
## redo COL repo+webapp with custom regions

```{r redo col repo+webapp, eval=F}

# see ohi-webapps/custom/col/prep_col.rmd

```


## create CDZ repo+webapp with custom regions

```{r create cdz repo+webapp, eval=F}

key = 'cdz'
# see ohi-webapps/custom/cdz/prep_cdz.rmd for prepping spatial
...
# run create_all.r straight through!

```

## refresh WebApp pages

- do this for gye Dec 16

```{r refresh WebApp pages, eval=F}
