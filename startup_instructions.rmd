...
### *config.r*
`config.r` has important information for the proper calculation and display of goal scores. Briefly, it sets several constants, sets the proper map orientation, and provides labeling for dimension descriptions for the Toolbox Application.  
