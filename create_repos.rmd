...
2. enter your study in repo_registry
...
This will search for the scenario folder (defined in repo_registry$scenario_name); if it exists it will populate a full repo and if not it will populate a prep repo. 
