# This is create_repos.Rmd
Note: Run this from the ohi-webapps@dev2 branch. 
This is a updated file to `edit_webapps.rmd` in the ohi-webapps@dev branch. 


## Initial Setup
NOTE:: must add info by hand to `ohi-webapps/repo_registry.csv`
```{r setup}
## set key ----
key <- 'uki' 
...
ohirepos::deploy_website_prep(gh_repo=key, study_area=study_area)
...
populate_layers(key, dir_repo, lyrs_gl, dir_origin, dir_scenario, multi_nation = FALSE)
...
unpopulate_layers_conf(key, dir_sandbox, dir_repo, git_url, default_scenario)
