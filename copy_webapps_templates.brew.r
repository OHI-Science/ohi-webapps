...
library(httr)
dir_gh  = '~/github/<%=git_repo%>/gh-pages_templates'
...
for (f in c('regions.brew.md',   # ohi-science.org/<%=git_repo%>/regions -> renders with layers/rgn_labels.csv
            'layers.brew.md',    # ohi-science.org/<%=git_repo%>/layers  -> renders with layers.csv
            'goals.brew.md',     # ohi-science.org/<%=git_repo%>/goals   -> renders with conf/goals.Rmd
            'scores.brew.md'     # ohi-science.org/<%=git_repo%>/scores  -> renders with scores.csv
)){
