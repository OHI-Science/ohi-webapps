# prep_bhi.r
# create baltic repo with original. See Issue #407: https://github.com/OHI-Science/issues/issues/407

# THIS SCRIPT IS NOW OBSOLETE. BHI WebApp originally created in April 2015 with
# PLC Basin Inters_BALTIC_EEZ_PLC1 regions; Redone in August 2015 with HOLAS
# Basin Intersect_HELCOMsubbasins_BALTIC_EEZ_excl_small_poly regions AND SAVED AS
# prep_bhi.Rmd.
