...
col = readOGR(dsn = file.path(dir_annex, 'col/spatial/custom/raw'),
...
# populate website and update_webapp_notravis (which calls calculate_scores_notravis(), update_results(), merge_published_draft(), and update_pages()
update_website(key)
