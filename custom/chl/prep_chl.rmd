...
shp = rgdal::readOGR(dsn = file.path(dir_spatial, 'custom'),
...
writeOGR(shp, dsn = dir_spatial, 
         layer = 'col_shp', driver = 'ESRI Shapefile', overwrite=T) 

## ave/rgn_offshore_data.csv on git-annex
write.csv(shp@data, file.path(dir_annex, 'shp/spatial', 'rgn_offshore_data.csv'))

# create lookup table with unique rgn_ids
col_rgns = shp@data
write_csv(col_rgns, '~/github/ohi-webapps/custom/shp/col_rgns_custom.csv')
