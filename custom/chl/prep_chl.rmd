...
This is for modifying the existing chl repo with new regions (16 total, up from original 12).
...
readr::write_csv(shp@data, file.path(dir_spatial, 'rgn_offshore_data.csv'))
