cut the 'this site represents'

Learn:
Learn about the [Ocean Health Index](www.oceanhealthindex.org), a holistic framework to quantify ocean health. Read the original *Nature* paper and learn how to conduct an assessment for Ecuador at [ohi-science.org](http://ohi-science.org).

Explore:
Explore input data and calculated output scores extracted for Ecuador from the global assessment as maps, histograms and tables in the interactive [Application](http://ohi-science.org/ecu/app/). Then explore the subcountry regions of Ecuador, the layers, goal models, and scores.

Build:
You can completely customize the input layers, subcountry regions, goal models, and even this website. Get started with the Documentation.




Other questions:
'Toolbox?' is it still the OHI Toolbox manual?

Move filesystem stuff to the README.mds

where to introduce scenarios
