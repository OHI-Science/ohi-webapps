...
print 'getting lists of countries rgn_gcs vs gadm2'
...
print 'looping over countries'
for rgn in sorted(tuple(df_rgn['rgn_name'])): # rgn = sorted(tuple(df_rgn['rgn_name']))[2]
	...
	# delete existing country specific feature classes
